...
├── plataformas/               ← regras de cada plataforma de envio
│   ├── activecampaign.md
│   ├── fluentcrm.md
│   └── mautic.md
├── clientes/                  ← uma pasta por cliente
│   └── <slug-do-cliente>/
│       ├── instrucoes.md      ← tipografia, cores, design, tom de voz, plataforma
...
3. **Identifique a plataforma de envio** desse cliente — está no campo "Plataforma" do `instrucoes.md`.
4. **Leia `plataformas/<plataforma>.md`** por completo (o que funciona, o que quebra, tags obrigatórias).
...
- **Aprendizado sobre uma plataforma** (algo do HTML que quebrou, um tag que faltou, um comportamento
  novo) → grave no `plataformas/<plataforma>.md`, na seção **"Aprendizados"**.
